...
def main():
    parser = argparse.ArgumentParser(
        description='-----AGWS sky coverage for GMACS------')
    ...
    for fieldno in range(args.field_start, args.field_end+1):
        ...
        if args.writecsv:
            ...
            if args.writepng:
                ...
                plt.xlim([-maxradarcsec, maxradarcsec])
                plt.ylim([-maxradarcsec, maxradarcsec])
    ...
    stats_df.to_csv(f'output/gmacs_gs_{args.aomode}.csv')
